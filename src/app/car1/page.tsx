...
export default function car1() {
    ...
    return(
        ...
        <div className="mt-5 mx-48 bg-gray-100 p-5 mb-5">
             ...
             {/* heading for car1 */}
            <h1 className="text-center mt-6 font-bold text-3xl"> <u> Toyota Corolla 2024 Price in Pakistan, Images, Review &
            Specs</u>
            </h1>

            {/* image for car1 details */}
            ...
            {/* pkr 50,00,000 */}
            <h1 className="text-green-600 text-center mt-9 text-xl font-mono">PKR 59.7-75.5 lacs</h1>
