...
export default function car2() {
    ...
    return(
        ...
        <div className="mt-5 mx-48 bg-gray-100 p-5 mb-5">
             ...
             {/* heading for car2 */}
            <h1 className="text-center mt-6 font-bold text-3xl"> <u> Suzuki Alto 2024 Price in Pakistan, Images, Review &
            Specs</u>
            </h1>

            {/* image for car2 details */}
            ...
            {/* pkr 50,00,000 */}
            <h1 className="text-green-600 text-center mt-9 text-xl font-mono">PKR 23.3-30.5 lacs</h1>
